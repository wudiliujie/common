...
func (c *CallInfo) GetDebug() string {
	return fmt.Sprintf("callINfo: %v >>%v", c.fInfo.id, c.args)
}
...
func (s *Server) Exec(ci *CallInfo) *CallInfo {
...
func (c *Client) AsynCall(id interface{}, _args ...interface{}) {
	...
	//log.Debug("增加一个call  %v，当前长度 %v", id, c.pendingAsynCall)
	// too many calls
